...
// copy from https://github.com/activej/activej/blob/master/examples/core/sql/src/main/java/advanced/util/HikariConfigConverter.java
public class HikariConfigConverter extends ComplexConfigConverter<HikariConfig> {
    ...
    private HikariConfigConverter() {
        // java.lang.UnsupportedClassVersionError: com/zaxxer/hikari/HikariConfig has been compiled by a more recent version of the Java Runtime (class file version 55.0)
        super(new HikariConfig()); // JDK11+
    }

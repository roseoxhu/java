...
import org.example.dao.impl.MySqlPollDaoImpl;
import org.example.module.MySqlPooledModule;
...
public final class PooledPollApp extends HttpServerLauncher {
    ...
    PollDao pollRepo(@Named("hikari") DataSource dataSource, Executor executor) {
        PollDao pollDao = new MySqlPollDaoImpl(dataSource, executor);
